          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="hidden sm:block text-body-l text-text-secondary">
                  Dashboard
                </span>
              </div>
              ...
              <div className="hidden md:flex items-center space-x-6">
                <a
                  href="/tasks"
                  className="text-body-l text-text-primary hover:text-main-purple transition-colors font-medium"
                >
                  Mis Tareas
                </a>
                <a
                  href="/profile"
                  className="text-body-l text-text-secondary hover:text-main-purple transition-colors"
                >
                  Perfil
                </a>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <a
                  href="/terms"
                  className="text-body-m text-text-secondary hover:text-main-purple transition-colors"
                >
                  Términos
                </a>
                <a
